    ...
    with open('fuzzValues.txt', 'w') as f:
        ...
        for input in input_list:
            ...
            try:
                ...
                f.write(f'Input for checkParseError was invalid.\n Error: {e}\n')
                flag = True
            try:
                parser.count_initial_comment_line(input)
            except Exception as e:
                f.write(f'Input for count_initial_comment_line was invalid.\n Error: {e}\n')
                flag = True
            if not flag:
                f.write(f'Input {input} was valid for all functions.\n')
